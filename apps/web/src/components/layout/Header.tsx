...
// ============================================================================
// Header Component (Quick Actions Bar)
// This renders inside geex-content__header, positioned to the right
// ============================================================================
      ...
      <div className="geex-content__header__action__wrap">
        <ul className="geex-content__header__quickaction">
          ...
          <li className="geex-content__header__quickaction__item">
            <a href="#" className="geex-content__header__quickaction__link">
          ...
          <li className="geex-content__header__quickaction__item">
            <a href="#" className="geex-content__header__quickaction__link">
              ...
              <span className="geex-content__header__badge">84</span>
            </a>
          </li>
          ...
          <li className="geex-content__header__quickaction__item">
            <a href="#" className="geex-content__header__quickaction__link">
              ...
              <span className="geex-content__header__badge bg-info">2</span>
            </a>
          </li>
          ...
          <li className="geex-content__header__quickaction__item">
            <a href="#" className="geex-content__header__quickaction__link">
              <img className="user-img" src="/img/avatar/user.svg" alt="user" />
            </a>
          </li>
        </ul>
      </div>
...
// ============================================================================
// Page Header Component (for page titles + header actions)
// ============================================================================
